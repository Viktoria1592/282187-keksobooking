...
var onOfferPinClick = function (event) {
  ...
  var clickedPin = findClosestElem(target, 'map__pin');
 ...
 * @param {HTMLElement} changedSelect
 * @param {HTMLElement} syncingSelect
 */
...
/**
 * Из-за спорного значение у value опции "не для гостей" (0 когда 100), сделан небольшой костыль на проверку value
 */
var syncRoomsWithGuests = function () {
  if (numOfRoomsSelectElem.options[numOfRoomsSelectElem.selectedIndex].value === '100') {
